package com.ssethhyy.chapter.playback
...
import com.ssethhyy.chapter.MainActivity
...
class PlaybackService : MediaSessionService() {
    ...
    private var chapters: List<com.ssethhyy.chapter.data.local.entities.Chapter> = emptyList()
