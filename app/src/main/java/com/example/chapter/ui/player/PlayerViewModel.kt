...
import com.example.chapter.playback.PlaybackService
...
class PlayerViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun addBookmark(note: String) {
        ...
        viewModelScope.launch {
            repository.insertBookmark(com.example.chapter.data.local.entities.Bookmark(
                bookId = book.id,
                position = position,
                note = note,
    ...
    fun deleteBookmark(bookmark: com.example.chapter.data.local.entities.Bookmark) {
        viewModelScope.launch {
